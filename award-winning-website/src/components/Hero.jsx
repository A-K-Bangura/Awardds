...
const Hero = () => {
  ...
  const videoSources = [hero1Video, hero2Video, hero3Video, hero4Video];
  ...
  const getVideoSource = (index) => {
    // Ensure index is within bounds (0-3 for array indexing)
    const adjustedIndex = (index - 1) % videoSources.length;
    return videoSources[adjustedIndex];
  };
      ...
      >
        ...
        <div className=" absolute z-40 left-0 top-0 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 px-2.5 maz-w-64 font-robert-regular text-blue-100">
            ...
            <Button
              ...
              containerClass="bg-yellow-300 flex items-center gap-2 text-black hover:bg-yellow-400"
            />
          </div>
        </div>
      </div>
